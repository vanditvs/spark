<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12 sidebar">
    <ul class="nav nav-sidebar text-right">
        <li class="{{HTML::activeState('admin')}}">
            <a href="{{route('admin')}}"><i class="glyphicon glyphicon-home"></i> Admin</a>
        </li>
        ...
        <li class="{{HTML::activeState('manage-blog-customize', [$blog->id], true)}}">
            <a href="{{route('manage-blog-customize', $blog->id)}}"><i class="glyphicon glyphicon-tint"></i> Customize</a>
        </li>
    </ul>
</div>